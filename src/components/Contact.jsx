...
const Contact = () => {
  ...
  useEffect(() => {
    axios.get(`http://localhost:9081/dukes-data/api/users/freelancer/${freelancerId}`)
  ...
  return (
    <Container>
      <Row className="justify-content-md-center">
        <Col md="8">
          <h2 className="text-center">Contact {freelancer && freelancer.user.name}</h2>
          <Form>
            <Form.Group controlId="formBasicEmail">
              <Form.Label>Email address</Form.Label>
              <Form.Control type="email" placeholder="Enter email" value={freelancer && freelancer.user.email} disabled />
            </Form.Group>
